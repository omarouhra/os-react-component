  ...
  return (
    <section className=''>
      <div className='flex flex-col items-start justify-between space-y-4 py-2 md:flex-row  md:items-center md:space-y-0 '>
        <p className='font-cal text-lg text-gray-700 dark:text-white md:text-xl'>
          {component.title}
        </p>
        <motion.div className=' relative flex h-[40px] w-full items-center justify-between space-x-3 md:h-[60px] md:w-auto md:justify-end'>
          <AnimatePresence>
            {activeTab === "code" && (
              <motion.div
              ...
              >
                ...
                <div className='relative'>
                  {activeCopyTag && (
                    <div className='absolute -top-12 right-[-15px] hidden min-w-[80px] animate-fade-in-up  rounded-md bg-blue-500 p-2 text-center text-xs text-white sm:inline-block'>
                      Copied 👍
                    </div>
                  )}
                  <button
      ...
      <div className='rounded-md shadow-xl'>
        {activeTab === "code" && (
          <div className='flex rounded-t-lg  bg-gray-600 dark:bg-gray-700'>
            ...
            <div
              className='flex items-center justify-between space-x-6 overflow-hidden bg-gray-700 px-6  capitalize text-white dark:bg-gray-800 
            md:min-w-[230px] '
            >
              <div
                className={`flex ${
        ...
        {activeTab === "preview" ? (
          <div className='mb-12 h-[250px] overflow-hidden rounded-md bg-gray-100 shadow  dark:bg-gray-800 md:h-[500px]'>

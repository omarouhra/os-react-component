...
function Cards() {
  ...
  return (
    <section className='space-y-20 py-20'>
      <motion.div
        animate={{
          height: !showModal ? 48 : 200,
          width: !showModal ? 48 : "40%",
          borderRadius: showModal ? 5 : 5,
          transition: { ease: [0.455, 0.03, 0.515, 0.955], duration: 0.2 },
        }}
        onClick={() => setShowModal(!showModal)}
        className=' relative flex cursor-pointer flex-col  items-start  justify-center overflow-hidden bg-gray-100 dark:bg-gray-800'
      >
        ...
        {showModal && (
          <motion.div
            ...
            className='px-5'
          >
            <h2 className='mb-3 font-cal text-2xl '>Title</h2>
